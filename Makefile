all:
	gcc -I src/include -L src/lib -o main main.c render.c control.c get_ai_move.c generate_moves.c perft.c eval.c generate_moves_ccp.c -lmingw32 -lSDL2main -lSDL2
...
eval.o: eval.c global.h generate_moves.h control.h eval.h generate_moves_CCP.h
	gcc -I src/include -L src/lib -c eval.c -lmingw32 -lSDL2main -lSDL2

generate_moves_ccp.o: generate_moves_ccp.c global.h generate_moves.h control.h generate_moves_ccp.h
	gcc -I src/include -L src/lib -c generate_moves_ccp.c -lmingw32 -lSDL2main -lSDL2